...
FILES=("SKILL.md" "scripts/__init__.py" "scripts/run.py" "scripts/events.py" "scripts/session_window.py" "scripts/minute_classifier.py" "scripts/plan_signals.py" "scripts/edit_counter.py" "scripts/revert_detector.py" "scripts/frustration_detector.py" "scripts/prompt_similarity.py" "scripts/tool_counter.py" "scripts/approval_counter.py" "scripts/model_classifier.py" "scripts/config_scanner.py" "scripts/output_schema.py" "scripts/extractor.py" "scripts/uploader.py" "scripts/rename.py" "scripts/logout.py")
fail=0
for f in "${FILES[@]}"; do
